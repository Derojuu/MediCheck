          ...
          {activeTab === "dashboard" && (
            <div className="space-y-8">
              ...
              <div className="flex justify-between items-center">
                <div>
                  <h1 className="font-montserrat font-bold text-3xl text-foreground">Pharmacy Dashboard</h1>
                  <p className="text-muted-foreground">Welcome to MedPlus Pharmacy - Victoria Island</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{stats.prescriptionsFilled}</div>
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium">Medications Verified</CardTitle>
                    <CheckCircle className="h-4 w-4 text-muted-foreground" />
                  </CardHeader>
                  <CardContent>
                    <div className="text-2xl font-bold">{stats.medicationsVerified}</div>
                    <p className="text-xs text-muted-foreground">
                      <span className="text-primary">+12</span> more than yesterday
                    </p>
                  </CardContent>
                </Card>
